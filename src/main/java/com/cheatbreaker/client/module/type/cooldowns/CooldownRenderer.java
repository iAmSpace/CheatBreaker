...
public class CooldownRenderer {
    ...
    public void lIIIIlIIllIIlIIlIIIlIIllI(Setting cBSetting, float f, float f2, int n) {
        ...
        ArmourStatusModule.renderItem.renderItemAndEffectIntoGUI(this.IIIIllIIllIIIIllIllIIIlIl.fontRendererObj, this.IIIIllIIllIIIIllIllIIIlIl.getTextureManager(), this.item, (int)((f + (float)(n2 / 2)) / f5), (int)((f2 + (float)(n2 / 2)) / f5));
