...
//        }
        ...
        if (this.keyCode == minecraft.gameSettings.keyBindJump.getKeyCode()) {
            ...
            Ref.getMinecraft().bridge$getFontRenderer().bridge$drawString(this.displayString, (n + this.width / 2.0f) - width / 2 + offset, (n2 + this.height / 2.0f - minecraft.fontRenderer.FONT_HEIGHT / 2 + 1.0f), pressed ? n4 : n3);
        }
    }
