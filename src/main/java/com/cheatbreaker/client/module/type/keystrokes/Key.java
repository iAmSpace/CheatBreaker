...
//        }
        ...
        if (this.keyCode == minecraft.gameSettings.keyBindJump.getKeyCode()) {
            ...
            int width = minecraft.fontRendererObj.getStringWidth(displayString);
            int offset = displayString.length() == 1 ? 1 : (displayString.contains("R") ? 2 : 1);
            minecraft.fontRendererObj.drawString(this.displayString, (int)(n + this.width / 2.0f) - width / 2 + offset, (int)(n2 + this.height / 2.0f - minecraft.fontRendererObj.FONT_HEIGHT / 2 + 1.0f), pressed ? n4 : n3);
        }
    }
