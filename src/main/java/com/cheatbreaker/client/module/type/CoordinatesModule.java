    ...
    public void onRender(GuiDrawEvent event) {
        ...
        if (!this.minecraft.ingameGUI.getChatGUI().getChatOpen() || ((Boolean) this.showWhileTyping.getValue())) {
            ...
            if (this.mode.getValue().equals("Horizontal")) {
                ...
                n4 = this.minecraft.fontRendererObj.drawStringWithShadow(object, 0, 0, this.coordinatesColor.getColorValue());
            } else {
                n4 = 50;
                f = (Boolean) this.hideYCoordinate.getValue() ? 8.066038f * 1.1777778f : (float) 16;
                this.minecraft.fontRendererObj.drawStringWithShadow("X: " + n, 0, 0, this.coordinatesColor.getColorValue());
                if (!((Boolean) this.hideYCoordinate.getValue())) {
                    this.minecraft.fontRendererObj.drawStringWithShadow("Y: " + n2, 0, 12, this.coordinatesColor.getColorValue());
                }
                this.minecraft.fontRendererObj.drawStringWithShadow("Z: " + n3, 0, (Boolean) this.hideYCoordinate.getValue() ? 12 : 24, this.coordinatesColor.getColorValue());
            }
            if (((Boolean)this.showDirection.getValue())) {
                ...
                this.minecraft.fontRendererObj.drawStringWithShadow(string, n4, (int) f - 4, this.directionColor.getColorValue());
