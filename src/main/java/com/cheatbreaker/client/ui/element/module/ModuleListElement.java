...
public class ModuleListElement extends AbstractScrollableElement {
    ...
    public void handleDrawElement(int mouseX, int mouseY, float partialTicks) {
        RenderUtil.drawRoundedRect(this.x, this.y, this.x + this.width, this.y + this.height + 2, 8, CheatBreaker.getInstance().globalSettings.isDarkMode() ? -13619151 : -657930);
        ...
        if (this.module == null && !this.llIlIIIlIIIIlIlllIlIIIIll) {
            ...
            Ref.modified$drawRect(this.x + 32, this.y + 4, this.x + 33, this.y + this.height - 4, CheatBreaker.getInstance().globalSettings.isDarkMode() ? 267547250 : 791621423);
            ...
            FontRegistry.getUbuntuMedium16px().drawString("CheatBreaker Settings".toUpperCase(), this.x + 38, (float)(this.y + 9), CheatBreaker.getInstance().globalSettings.isDarkMode() ? 0xFFFFFFFF : -1358954495);
            Ref.modified$drawRect(this.x + 38, this.y + 17, this.x + this.width - 6, this.y + 18, CheatBreaker.getInstance().globalSettings.isDarkMode() ? -14211288 : 791621423);
            int n3 = 0;
            ...
            Ref.modified$drawRect(this.x + 32, this.y + 4, this.x + 33, this.y + (Math.max(this.height, this.IlllIllIlIIIIlIIlIIllIIIl)) - 4, CheatBreaker.getInstance().globalSettings.isDarkMode() ? -14211288 : 791621423);
