...
public class ModulePreviewElement extends AbstractModulesGuiElement {
    ...
    public void handleDrawElement(int mouseX, int mouseY, float partialTicks) {
        ...
        if (this.module == CheatBreaker.getInstance().moduleManager.armourStatus) {
            n3 = -10;
            object = "329/329";
            f2 = Minecraft.getMinecraft().fontRendererObj.getStringWidth((String)object);
            Minecraft.getMinecraft().fontRendererObj.drawStringWithShadow((String)object, (int)((float)(this.x + 1 + this.width / 2) - f2 / 2.0f), this.y + this.height / 2 - 18, -1);
        } else if (this.module == CheatBreaker.getInstance().moduleManager.potionStatus) {
            n4 = -30;
            Minecraft.getMinecraft().fontRendererObj.drawStringWithShadow("Speed II", this.x + 8 + this.width / 2 - 20, this.y + this.height / 2 - 36, -1);
            Minecraft.getMinecraft().fontRendererObj.drawStringWithShadow("0:42", this.x + 8 + this.width / 2 - 20, this.y + this.height / 2 - 26, -1);
            ...
            Minecraft.getMinecraft().fontRendererObj.drawString("Score", this.x + this.width / 2, this.y + this.height / 2 - 40, -1);
            Minecraft.getMinecraft().fontRendererObj.drawStringWithShadow("Steve", this.x + 24, this.y + this.height / 2 - 28, -1);
            Minecraft.getMinecraft().fontRendererObj.drawStringWithShadow("Alex", this.x + 24, this.y + this.height / 2 - 18, -1);
            Minecraft.getMinecraft().fontRendererObj.drawString(EnumChatFormatting.RED + "0", this.x + this.width - 26, this.y + this.height / 2 - 18, -1);
            Minecraft.getMinecraft().fontRendererObj.drawString(EnumChatFormatting.RED + "1", this.x + this.width - 26, this.y + this.height / 2 - 28, -1);
        }
        if (this.module == CheatBreaker.getInstance().moduleManager.cooldowns) {
            ...
            float f3 = (float)Minecraft.getMinecraft().fontRendererObj.getStringWidth((String)object) * f2;
            if (this.module.getPreviewType() == null) {
                Minecraft.getMinecraft().fontRendererObj.drawString((String)object, (int)(((float)(this.x + 1 + this.width / 2) - f3 / 2.0f) / f2), (int)((float)(this.y + this.height / 2 - 32) / f2), -13750738);
            } else {
                Minecraft.getMinecraft().fontRendererObj.drawStringWithShadow((String)object, (int)(((float)(this.x + 1 + this.width / 2) - f3 / 2.0f) / f2), (int)((float)(this.y + this.height / 2 - 32) / f2), -1);
            }
